...
echo ""
echo -e "\033[32m                   版本：常规方式 -- 本地数据库(只用web版本)\033[0m"
echo ""
...
wget http://www.cwj95.com/shell/CG/CG/server.conf
wget http://www.cwj95.com/shell/CG/openvpn-auth-pam.so
wget http://www.cwj95.com/shell/CG/BD/1/connect.sh
wget http://www.cwj95.com/shell/CG/BD/1/disconnect.sh
wget http://www.cwj95.com/shell/CG/BD/1/test.sh
...
cd /etc/pam.d
wget http://www.cwj95.com/shell/CG/BD/openvpn
cd /home
wget  http://www.cwj95.com/shell/CG/vpn.sql
echo "安装 完毕"
...
Client='                      本地数据库版安装完毕
         ...
         常规模板地址：http://www.cwj95.com/shell/CG/CG/openvpn.ovpn
